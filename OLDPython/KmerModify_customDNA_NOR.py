...
for name in glob.glob('K-MersRandom_Custom_NOR/**/**/'):
  for nameEug in glob.glob(name + '/*.txt'):
    ...
    KmerName = 'K-MersRandomMut_custom_NOR/'+test+'/'+type+'/'+Filename
    KmerFile = open('K-MersRandomMut_custom_NOR/'+test+'/'+type+'/'+Filename, 'w')
