...
model.add(layers.Conv1D(64, 5, padding="valid", activation="relu", strides=2,kernel_regularizer=regularizers.l2(0.1), bias_regularizer=regularizers.l2(0.1)))
for layer in model.layers:
    print(layer.name)
    print(layer.output_shape)
model.add(layers.Dropout(0.5))
# model.add(layers.LSTM(32, input_shape=(None,64)))
for layer in model.layers:
    print(layer.name)
    print(layer.output_shape)
...
for layer in model.layers:
    print(layer.name)
    print(layer.output_shape)
model.add(layers.Dense(num_labels,kernel_regularizer=regularizers.l2(0.1), bias_regularizer=regularizers.l2(0.1)))
